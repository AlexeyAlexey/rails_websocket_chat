...
class ChatroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chatroom" do
    assert_difference('Chatroom.count') do
      post chatrooms_url, params: { chatroom: { sid: @chatroom.sid, topic: @chatroom.topic } }
    end
  ...
  test "should update chatroom" do
    patch chatroom_url(@chatroom), params: { chatroom: { sid: @chatroom.sid, topic: @chatroom.topic } }
